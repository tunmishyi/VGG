...
let webDevs = employees.filter(employee => employee.Job == 'Web Developer');
let webDevsNigeria = employees.filter(employee => (employee.Job == 'Web Developer' && employee.Country == "Nigeria"));
let EmpAge = employees.filter(employee => employee.age < 20);
let EmpActive = employees.filter(employee => employee.active);
let salaries = employees.map(employee => employee.salary);
let highestSalary = Math.max(...salaries);

console.log(webDevs);
console.log(webDevsNigeria);
console.log(EmpAge);
console.log(EmpActive);
